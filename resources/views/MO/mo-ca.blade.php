...
<div class="container-fluid mt-4">
          ...
          <tr>
              ...
              <td>
                  @if($item->l <($item->qty * $mo->qty ))
                      <a href="{{ Route('RfqTampil') }}" class="btn btn-danger delete-confirm" role="">Bahan Kurang</a>
                      @else
  ...
  <form action="{{ url('/mo/produksi/'.$mo->kode_mo ) }}" method="post" class="btn p-0" name="input-form" id="input-form">
      {{ csrf_field() }}
